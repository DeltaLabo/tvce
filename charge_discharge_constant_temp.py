...
# Make sure to run the script with sudo permissions to see all USB devices
...
# ~ dev = finddev(idVendor=0x1ab1, idProduct=0xe11, find_all=True)
# ~ for d in dev:
    # ~ d.reset()
...
print("Conected resources")
print(res ,"\n")
print("Detected instruments: ", len(res), end="\n")

#ESTA PARTE LEE LOS INSTRUMENTOS Y BUSCA Y ASIGA LAS FUENTES 1 Y 2 SEGUN ID
...
# ~ Source.encender_canal(1) #Solo hay un canal (el #1)
